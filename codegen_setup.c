...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Final Fantasy Tactics",
    .project_root_env = "FINFANTACRECOMP_PROJECT_ROOT",
    .build_dir_env = "FINFANTACRECOMP_BUILD_DIR",
    .force_setup_env = "FINFANTACRECOMP_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SCUS_942.21_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Final_Fantasy_Tactics_Recompiled",
    .prepare_note =
